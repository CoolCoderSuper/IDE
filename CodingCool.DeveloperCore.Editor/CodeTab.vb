...
#Region "Components"
    ...
    Private items As List(Of AutocompleteItem)
...
#Region "Styles"
    ...
    Private BlueStyle As TextStyle = New TextStyle(Brushes.Blue, Nothing, FontStyle.Regular)
    Private BoldStyle As TextStyle = New TextStyle(Nothing, Nothing, FontStyle.Bold Or FontStyle.Underline)
    Private BrownStyle As TextStyle = New TextStyle(Brushes.Brown, Nothing, FontStyle.Italic)
    Private GrayStyle As TextStyle = New TextStyle(Brushes.Gray, Nothing, FontStyle.Regular)
    Private GreenStyle As TextStyle = New TextStyle(Brushes.Green, Nothing, FontStyle.Italic)
    Private MagentaStyle As TextStyle = New TextStyle(Brushes.Magenta, Nothing, FontStyle.Regular)
    Private MaroonStyle As TextStyle = New TextStyle(Brushes.Maroon, Nothing, FontStyle.Regular)
    Private ObjectStyle As TextStyle = New TextStyle(Brushes.DarkGreen, Nothing, FontStyle.Regular)
    Private MethodStyle As TextStyle = New TextStyle(Brushes.BurlyWood, Nothing, FontStyle.Regular)
    Private HyperLinkStyle As TextStyle = New TextStyle(Brushes.Blue, Nothing, FontStyle.Underline)
...
#Region "Intialization"
    ...
    Private Sub InitializeComponent()
        ...
        docMap = New FastColoredTextBoxNS.DocumentMap
        autocompleteImg = New System.Windows.Forms.ImageList(components)
        popupMenu = New AutocompleteMenu(TxtEditor)
        CType(TxtEditor, System.ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        '
        'txtEditor
        '
        TxtEditor.AutoCompleteBrackets = True
        TxtEditor.AutoScrollMinSize = New System.Drawing.Size(2, 18)
        TxtEditor.BackBrush = Nothing
        TxtEditor.BackColor = System.Drawing.Color.FromArgb(CType(CType(138, Byte), Integer), CType(CType(138, Byte), Integer), CType(CType(136, Byte), Integer))
        TxtEditor.CharHeight = 18
        TxtEditor.CharWidth = 9
        TxtEditor.Cursor = System.Windows.Forms.Cursors.IBeam
        TxtEditor.DisabledColor = System.Drawing.Color.FromArgb(CType(CType(100, Byte), Integer), CType(CType(180, Byte), Integer), CType(CType(180, Byte), Integer), CType(CType(180, Byte), Integer))
        TxtEditor.Dock = System.Windows.Forms.DockStyle.Fill
        TxtEditor.Font = New System.Drawing.Font("Cascadia Code", 12.0!)
        TxtEditor.ForeColor = System.Drawing.Color.White
        TxtEditor.IsReplaceMode = False
        TxtEditor.Location = New System.Drawing.Point(0, 0)
        TxtEditor.Name = "txtEditor"
        TxtEditor.Paddings = New System.Windows.Forms.Padding(0)
        TxtEditor.SelectionColor = System.Drawing.Color.FromArgb(CType(CType(60, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(255, Byte), Integer))
        TxtEditor.ShowFoldingLines = True
        TxtEditor.Size = New System.Drawing.Size(16, 100)
        TxtEditor.TabIndex = 1
        TxtEditor.ToolTipDelay = 250
        TxtEditor.Zoom = 100
        '
        'docMap
        '
        docMap.BackColor = System.Drawing.Color.FromArgb(CType(CType(136, Byte), Integer), CType(CType(136, Byte), Integer), CType(CType(136, Byte), Integer))
        docMap.Dock = System.Windows.Forms.DockStyle.Right
        docMap.ForeColor = System.Drawing.Color.Maroon
        docMap.Location = New System.Drawing.Point(16, 0)
        docMap.Name = "docMap"
        docMap.Size = New System.Drawing.Size(184, 100)
        docMap.TabIndex = 1
        docMap.Target = TxtEditor
        docMap.Text = "Document Map"
        '
        'autocompleteImg
        '
        autocompleteImg.ImageStream = CType(resources.GetObject("autocompleteImg.ImageStream"), System.Windows.Forms.ImageListStreamer)
        autocompleteImg.TransparentColor = System.Drawing.Color.Transparent
        autocompleteImg.Images.SetKeyName(0, "script_16x16.png")
        autocompleteImg.Images.SetKeyName(1, "app_16x16.png")
        autocompleteImg.Images.Add("Method", My.Resources.method_new)
        autocompleteImg.Images.Add("Keyword", My.Resources.keyword)
        autocompleteImg.Images.Add("Property", My.Resources.property_new)
        autocompleteImg.Images.Add("Class", My.Resources.class_new)
        ...
        Controls.Add(docMap)
        CType(TxtEditor, System.ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
...
#Region "Events"
    ...
    Private Sub txtEditor_TextChanged(sender As Object, e As TextChangedEventArgs) Handles TxtEditor.TextChanged
        ...
        '        objType.GetProperties(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                   items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 4})
        '                                                                               End Sub)
        '        objType.GetMethods(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 2})
        '                                                                            End Sub)
        '        objType.GetNestedTypes(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                    items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 5})
        '                                                                                End Sub)
        '        objType.GetFields(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                               items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 4})
        '                                                                           End Sub)
        '    Else
        ...
        '                objAssemblyType.GetProperties(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                                   items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 4})
        '                                                                                               End Sub)
        '                objAssemblyType.GetMethods(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                                items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 2})
        '                                                                                            End Sub)
        '                objAssemblyType.GetNestedTypes(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                                    items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 5})
        '                                                                                                End Sub)
        '                objAssemblyType.GetFields(Reflection.BindingFlags.Static).ToList().ForEach(Sub(x)
        '                                                                                               items.Add(New MethodAutocompleteItem(x.Name) With {.ImageIndex = 4})
        '                                                                                           End Sub)
        '                Exit For
        '            End If
